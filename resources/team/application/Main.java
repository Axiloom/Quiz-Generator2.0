...
import application.AddMenu;
import application.ExitMenu;
import application.MainMenu;
import application.Question;
import application.QuizMenu;
import application.SaveMenu;
import application.StatisticsMenu;
...
public class Main extends Application {
  ...
  private static application.Question question; // application.Question Class instance
  private static application.MainMenu mainMenu; // instance of Class that constructs the main menu
  private static application.SaveMenu saveMenu; // instance of Class that constructs the save menu
  private static application.AddMenu addMenu; // instance of Class that constructs the add menu
  private static application.QuizMenu quizMenu; // instance of Class that constructs the quiz menu
  private static application.StatisticsMenu statisticsMenu; // instance of Class that constructs the stats menu
  ...
  public void start(Stage primaryStage) {
    try {
      ...
      mainMenu = new application.MainMenu(primaryStage);
      saveMenu = new application.SaveMenu(primaryStage);
      addMenu = new application.AddMenu(primaryStage);
      quizMenu = new application.QuizMenu(primaryStage);
      statisticsMenu = new application.StatisticsMenu(primaryStage);
      application.ExitMenu exitMenu = new ExitMenu(primaryStage);
   ...
   */
  protected static application.Question getQuestion() {
    return question;
  }
