...
// Due: 5-2-19
// Title: Exit Menu 
// Files: application.ExitMenu.java
...
/**
 * application.ExitMenu Class constructs the GUI for the application.ExitMenu to display whether to save and exit or to exit
 * without saving.
 * 
 * @author ATeam-99
 *
 */
public class ExitMenu extends application.Main {
  ...
  /**
   * application.ExitMenu Constructor that declares the field variables and sets the background color
   * 
  ...
  /**
   * Initializes a BorderPane of the application.ExitMenu screen
   * 
   * @return root - BorderPane of the application.ExitMenu screen
   */
  ...
  private void setCenterPanel() {
    ...
    save.setOnAction(e -> { // save questions
      ...
      if (file.equals("")) {
        ...
        primaryStage.setScene(application.Main.getExitScene());
