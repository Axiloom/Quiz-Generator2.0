 ...
 *
 */
public class MainMenu extends application.Main {
  ...
  private void setLeftPanel() {
    ...
    // Listeners
    save.setOnAction(event -> primaryStage.setScene(application.Main.getSaveScene()));
    add.setOnAction(event -> primaryStage.setScene(application.Main.getAddScene()));
  ...
  private void setRightPanel() {
    ...
    for (String s : application.Main.getQuestion().getTopics()) {
  ...
  private void setBottomPanel() {
    ...
    start.setOnAction(event -> {
      ...
      if (selected.getItems().isEmpty() || numberOfQuestions.getText().isEmpty()) {
        ...
        primaryStage.setScene(application.Main.getMainScene());
      }
      ...
      // Continue onto quiz
        ...
        for (String topic : selected.getItems()){
            totalQuestions += application.Main.getQuestion().getQuestions(topic).size();
        }
        ...
        // Get all questions
        for (String topic : selected.getItems()){
          questions.addAll(application.Main.getQuestion().getQuestions(topic));
        }
        ...
        application.Main.setupQuizScene(questions);
        application.Main.setupStatisticsScene(Integer.parseInt(numberOfQuestions.getText()));
